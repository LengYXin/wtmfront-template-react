        ...
        return <>
         ...
         <FormItem label="年龄" {...formItemLayout}>
            {getFieldDecorator('age',{
                rules: [{"required":true,"message":"Please input your undefined!"}],
                initialValue: initialValue('age','int32'),
            })(
               <DataEntry {...this.props}  format="int32"  placeholder='年龄'  />
            )}
        </FormItem> 
         <FormItem label="学校" {...formItemLayout}>
            {getFieldDecorator('schoolId',{
                rules: [{"required":true,"message":"Please input your undefined!"}],
                initialValue: initialValue('schoolId','int64'),
            })(
               <DataEntry {...this.props}  format="int64"  placeholder='学校'  />
            )}
        </FormItem> 
